...
public class ShoppingCart {
    ...
    private HashMap<Product, Integer> cart;    //<Product, stock>
    private int cartId;
    private Inventory inventory;

    /**
     * A constructor for the ShoppingCart class that initializes a car HashMap and int cartId.
    ...
    /**
     * Get the ShoppingCart HashMap containing the Product and Stock of the product.
     ...
     * @return the Set<Product> of keys from the HashMap cart.
     */
     ...
     * @param product is the Product being added.
     ...
     * @param product is the Product being removed.
