...
public class StoreView {
    ...
    /**
     * A constructor for the StoreView class.
     * @param sm is the StoreManager object that will be used to access the inventory and shopping cart.
     */
    ...
    /**
     * A method that makes all of teh necessary buttons for the GUI.
     * @return the JPanel containing these buttons.
     */
    ...
    /**
     * A method that adds products to the JPanel.
     * @return the JPanel.
     */
    ...
    /**
     * A method that adds the products to the JFrame.
     * @param p is the product added.
     * @param pane is of type Container.
     */
    ...
    /**
     * The main method that runs the actual GUI.
